...
<footer class="btm-footer">
        ...
        <div class="footerFlex">
            ...
            <div class="columnThree">               
                ...
                <ul class="socials">
                    ...
                    <li class="fr-fic"><a href="https://www.tiktok.com/@Verifenfunding" target="_blank"><img class="fr-fic" src="{{ asset('assets/images/tiktok-icon.png') }}" alt=""></a><br>
                    </li>
                    <li class="fr-fic"><a href="https://x.com/Verifenfunding" target="_blank"><img src="{{ asset('assets/images/x-twitter.png') }}" alt=""></a><br>
                    </li>
    ...
    <div class="disclaimerSec">
        <div class="container">
            ...
            <p>By submitting an application to Verifen, you agree to receive calls and text/SMS messages,
