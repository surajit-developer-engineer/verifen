           ...
           <div class="callSecwe mr-0">
            ...
            <!-- progressbar -->
                <div class="hdr-progress-bar">
                    <ul id="progressbar">
                        <li class="active">Basic Company Information</li>
    ...
    <div class="container">      
        <form id="msform">           
            ...
            <fieldset>
                <div class="form-card active">
                    <div class="first-step-sub-step-one">
                        <div class="title-hdn">
                            <h3>Investor Application</h3></br>
                            <p>Become a partner with Verifen and start earning interest. Complete the investor application below to get started.</p>
                            <div class="menu">
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-three">
                        <h3>What is your Company Address</h3>
                         <div class="step-form-field">
                            <label>Company Address</label>
                            <input type="text" name="ca" placeholder="Company Address" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-six">
                        <h3>What is your Potential Investment Amount</h3>
                        <div class="menu">
                            <a class="button">Up to $50,000</a>
                            <a class="button">$50,000 - $100,000</a>
                            <a class="button">$100,000 - $250,000</a>
                            <a class="button">$250,000 - $500,000</a>
            ...
            <fieldset>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-two">
                        <h3>What is your Contact Full Name</h3>
                        <div class="step-form-field">
                            <label>Contact Full Name</label>
                            <input type="text" name="cm" placeholder="Full Name" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-nine">
                        ...
                        <div class="step-form-field">
                            <label>Email Address</label>
                            <input type="text" name="businessAddress" placeholder="Email Address" />
                        </div>
                    </div>
                </div>                
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-nine">
                        ...
                        <div class="step-form-field">
                            <label>Phone Number</label>
                            <input type="text" name="fullName" placeholder="Phone Number" />
                        </div>
                    </div>
                </div>
                <input type="button" name="next" class="next action-button" value="Review & Submit" style="display: none;" />
            </fieldset>  
