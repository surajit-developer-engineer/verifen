        ...
        <form id="msform">           
            ...
            <fieldset>
              <div class="thanks-message">
                ...
                <p>Thank you for applying with Verifen. One of our experienced Business Advisors will reach out to 
                    you shortly to discuss your options. We're here to help you access the capital you need. quickly, clearly, 
                    and with expert support every step of the way.</p>
                <div class="menu">
                    <a href="/business-loan-application/step-3" class="button toplink formsim-btn">Continue</a>                                
                </div>
              </div>
            </fieldset>
        </form>
