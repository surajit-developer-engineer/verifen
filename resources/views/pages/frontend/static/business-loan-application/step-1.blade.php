            ...
            <fieldset>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-three">
                        ...
                        <div class="menu">
                            ...
                            <a class="button">Corporation</a>
                            <a class="button">Sole Proprietorship</a>
                            <a class="button">Partnership</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-five">
                        ...
                        <div class="step-form-field">
                            ...
                            <input type="text" name="ein" placeholder="Business EIN" />
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-six">
                        ...
                        <div class="menu">
                            ...
                            <a class="button">$25,000–$49,999</a>
                            <a class="button">$50,000–$99,999</a>
                            <a class="button">$100,000–$149,999</a>
                            <a class="button">$150,000–$299,999</a>
                            <a class="button">$300,000–$499,999</a>
                            <a class="button">$500,000+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-eight">
                        ...
                        <div class="step-form-field">
                            ...
                            <input type="text" name="cashOnHand" placeholder="500" />
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-nine">
                        ...
                        <div class="menu">
                            ...
                            <a class="button">Cash Flow</a>
                            <a class="button">Equipment Purchase</a>
                            <a class="button">Business Expansion</a>
                            <a class="button">Inventory</a>
                            <a class="button">Payroll</a>
                            <a class="button">Marketing</a>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-ten">
                        ...
                        <div class="step-form-field">
                            ...
                            <input type="text" name="annualRevenue" placeholder="500" />
                            <i class="fa fa-usd" aria-hidden="true"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-eleven">
                        ...
                        <div class="menu">
                            ...
                            <a class="button">Fair (600–679)</a>
                            <a class="button">Good (680–719)</a>
                            <a class="button">Excellent (720+)</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card">
                    <div class="first-step-sub-step-eleven">
                        ...
                        <div class="menu">
                            <a class="button">Construction</a>
                            <a class="button">Transportation</a>
                            <a class="button">Food Services</a>
                            <a class="button">Financial Services</a>
                            <a class="button">Software</a>
                            <a class="button">Insurance</a>
                            <a class="button">Real Estate</a>
                            <a class="button">Retail</a>
                            <a class="button">Warehousing</a>
                            <a class="button">Other</a>
                        </div>
                    </div>
                </div>
...
<!--=============== End Step Form ===============-->
    ...
    $(".next").click(function () {
        ...
        var stepIndex = $("fieldset").index(next_fs);
    ...
    $(".previous").click(function () {
        ...
        var stepIndex = $("fieldset").index(previous_fs);
        updateProgressBar(stepIndex);
        setProgressBar(--current);
    });

    // Handle form-card substeps
    $("fieldset").each(function () {
        ...
        function showCard(index) {
            ...
            $activeCard.data("completed", false); // Reset for each show
            $activeCard.addClass("active").fadeIn();
            $nextBtn.hide();
            ...
            if ($inputs.length > 0) {
                ...
                $inputs.on("change.substep", function () {
                    var $this = $(this);
                    if ($this.val().trim() !== "") {
                        goToNextCard();
                    }
    ...
    <script>
        document.querySelectorAll(".upload").forEach(function(inputEl) {
        inputEl.addEventListener("change", function() {
            const fileName = this.files[0]?.name || "";
            const fileInput = this.closest(".step-form-field").querySelector(".file-name");
